<?php
  ...
  $lists_notes_display = "
        <h1 id=\"list\" style=\"color: white;margin-bottom:10px; position:relative;top:10px;border-radius:15px; padding: 5px 20px; background-color: #5cb874;\">Lists</h1>
        ...
        <li><span style=\"color:#5cb874;\">List()</span> creates a new list that is empty. It needs no parameters and returns an empty list.</li>
        <li> <li><span style=\"color:#5cb874;\">add(item)</span> adds a new item to the list. It needs the item and returns nothing. Assume the item is not already in the list.</li>
        <li><span style=\"color:#5cb874;\">remove(item)</span> removes the item from the list. It needs the item and modifies the list. Assume the item is present in the list.</li>
        <li><span style=\"color:#5cb874;\">Search(item)</span> searches for the item in the list. It needs the item and returns a Boolean value.</li>
        <li><span style=\"color:#5cb874;\">is_empty()</span>tests to see whether the list is empty. It needs no parameters and returns a Boolean value.</li>
        <li><span style=\"color:#5cb874;\">size()</span> returns the number of items in the list. It needs no parameters and returns an integer</li>
        <li><span style=\"color:#5cb874;\">append(item)</span> adds a new item to the end of the list making it the last item in the collection. It needs the item and returns nothing. Assume the item is not already in the list</li>
        <li><span style=\"color:#5cb874;\">index(item)</span> returns the position of item in the list. It needs the item and returns the index. Assume the item is in the list.</li>
        <li><span style=\"color:#5cb874;\">insert(pos,item)</span> adds a new item to the list at position pos. It needs the item and returns nothing. Assume the item is not already in the list and there are enough existing items to have position pos.</li>
        <li><span style=\"color:#5cb874;\">pop()</span> removes and returns the last item in the list. It needs nothing and returns an item. Assume the list has at least one item</li>
        <li><span style=\"color:#5cb874;\">pop(pos)</span> removes and returns the item at position pos. It needs the position and returns the item. Assume the item is in the list.</li>
        ...
        <div>
        <img src=\"images/linked-list.png\" alt=\"\">
</div> 
        ...
        <div>
        <img src=\"images/double-list.png\" alt=\"\">
</div>
        ...
        <div>
        <img src=\"images/circular-lists.png\" alt=\"\">
</div>
  ";
  ...
  $queue_notes_display = "
        <h1 id=\"queue_def\" style=\"color: white;margin-bottom:10px;position:relative;top:10px;border-radius:15px; padding: 5px 20px; background-color: #5cb874;\">Queues</h1>
        <p>A queue is an ordered group of homogeneous items of elements.</p>
        ...
        <li><span style=\"color=#5cb874\">Queue()</span> creates a new queue that is empty. It needs no parameters and returns an empty queue.</li>
        <li><span style=\"color=#5cb874\">enQueue(item)</span> adds a new item to the rear of the queue. It needs the item and returns nothing.</li>
        <li><span style=\"color=#5cb874\">deQueue()</span> removes the front item from the queue.It needs no parameters and returns the item. The queue is modified.</li>
        <li><span style=\"color=#5cb874\">is_empty()</span> tests to see whether the queue is empty. It needs no parameters and returns a Boolean value.</li>
        <li><span style=\"color=#5cb874\">size()</span> returns the number of items in the queue. It needs no parameters and returns an integer</li>
  ...
  $stack_notes_display = "
        <h1 id=\"def_stack\" style=\"color: white;margin-bottom:10px;position:relative;top:10px;border-radius:15px; padding: 5px 20px; background-color: #5cb874;\">Stacks</h1>
        <p>A stack is an ordered list in which all insertions and deletions are made at one end called the top.</p>
        ...
        <li><span style=\"color=#5cb874\">Stack()</span> - creates a new stack that is empty. It needs no parameters and returns an empty stack</li>
        <li><span style=\"color=#5cb874\">push(item)</span> -adds a new item to the top of the stack. It needs the item and returns nothing</li>
        <li><span style=\"color=#5cb874\">pop()</span> - removes the top item from the stack. It needs no parameters and returns the item. The stack is modified</li>
        <li><span style=\"color=#5cb874\">peek()</span>- returns the top item from the stack but does not remove it. It needs no parameters. The stack is not modified.</li>
        <li><span style=\"color=#5cb874\">is_empty()</span> - tests to see whether the stack is empty. It needs no parameters and returns a Boolean value.</li>
        <li><span style=\"color=#5cb874\">size()</span> - returns the number of items on the stack. It needs no parameters and returns an integer</li>
        ...
        <div>
        <img src=\"images/stack-operation.png\" alt=\"\">
        </div> 
  ...
  $sorting_notes_display = "
        <h1 id=\"sorting_def\" style=\"color: white;margin-bottom:10px;position:relative;top:10px;border-radius:15px; padding: 5px 20px; background-color: #5cb874;\">Sorting</h1>
        <p>Sorting is a process that organizes or rearranges a collection of data into either ascending or descending order.</p>
        ...
        <ul>
        <li><span style=\"color:#5cb874;\">Time Complexity</span>:
          ...
          <li><span style=\"color:#5cb874;\">Space Complexity</span>:
          ...
          <li><span style=\"color:#5cb874;\">Stability</span>
          ...
          <li><span style=\"color:#5cb874;\">Internal sort or External sort</span>:
          ...
          <li><span style=\"color:#5cb874;\">Recursive or Non Recursive</span>:
        ...
        <div><img src=\"gifs/selection-sort.gif\" alt=\"\"></div>
        ...
        <div><img src=\"gifs/insertion-sort.gif\" alt=\"\"></div>
        ...
        <div><img src=\"gifs/bubble-sort.gif\" alt=\"\"></div>
        ...
        <div><img src=\"gifs/merge-sort\" alt=\"\"></div>
        ...
        <p>The quick-sort algorithm consists of the following three steps:
          ...
          <li><span style=\"color:#5cb874;\">Recursion</span>:
            <p>Recursively sort the sublists separately.</p>
          </li>
          <li><span style=\"color:#5cb874;\">Conquer</span>:
            <p>Put the sorted sublists together by a simple concatenation.</p>
          </li>
        </p>
       <div> <img src=\"gifs/quick-sort.gif\" alt=\"\"></div>
  ...
  $searching_notes_display = "
        <h1 id=\"searching_def\" style=\"color: white;margin-bottom:10px; position:relative; top:10px;border-radius:15px;padding: 5px 20px; background-color: #5cb874;\">Searching</h1>
        <p>The process used to find the location of a target among a list of objects.</p>
        ...
        <h3 id=\"unordered_search\" style=\"color: #5cb874;\">Unordered Linear Search</h3>
        <p>Search an unordered array of integers for a value and return its index if the value is found. Otherwise, return -1.</p>
        <h3 id=\"ordered_search\" style=\"color: #5cb874;\">Ordered Linear Search</h3>
        ...
        <div>
        <img src=\"gifs/binary-search.gif\" alt=\"\">
        </div>
        <p>Search an ordered array of integers for a value and return its index if the value is found. Otherwise, return -1.</p>
  ...
  $graphs_notes_display = "
        <h1 id=\"graph_def\" style=\"color: white;margin-bottom:10px;position:relative;top:10px;border-radius:15px; padding: 5px 20px; background-color: #5cb874;\">Graphs</h1>
        <p>A data structure that consists of a set of nodes (vertices) and a set of edges that relate the nodes to each other</p>
        ...
        <p>A <span style=\"color: #5cb874;\">subgraph</span> S is formed from graph G by selecting a subset Vs of G’s vertices and a subset Es of G’s edges such that for every edge E in Es, both of its vertices are in Vs.</p>
        <p>The <span style=\"color: #5cb874;\">degree</span> of a node is the number of edges it has</p>
        <p>The <span style=\"color: #5cb874;\">in-degree</span> of a node is the number of in-edges it has</p>
        <p>The <span style=\"color: #5cb874;\">out-degree</span> of a node is the number of outedges it has</p>
        ...
        <p><span style=\"color: #5cb874;\">A free tree</span> is a connected, undirected graph with no simple cycles. An equivalent definition is that a free tree is connected and has <i>|V| − 1</i> edges</p>
        ...
        <div><img src=\"images/directed graph.png\" alt=\"\"></div>
        ...
        <div><img src=\"images/undirected graph.png\" alt=\"\"></div>
        ...
        <p>A 2-D array has a mark at <i>[i][j]</i> if there is an edge from node i to node j</p>
        <div><img src=\"images/adj matrix1.png\" alt=\"\"></div>
        <div><img src=\"images/adj matrix2.png\" alt=\"\"></div>
  ...
  ";
  $trees_notes_display = "
        <h1 id=\"def_tree\" style=\"color: white;margin-bottom:10px;position:relative;top:10px;border-radius:15px; padding: 5px 20px; background-color: #5cb874;\">Trees</h1>
        <p>A tree structure means that the data are organized so that items of information are related by branches.</p>
        ...
        <p>Some Tree terminologies include:
          <ul>
            <li><span style=\"color: #5cb874;\">Root</span> - the top node in the tree</li>
            <li><span style=\"color: #5cb874;\">Child</span> - A node directly connected to another node when moving away from the Root.</li>
            <li><span style=\"color: #5cb874;\">Parent</span> - The converse notion of a child</li>
            <li><span style=\"color: #5cb874;\">Sibling</span> - A group of nodes with the same parent.</li>
            <li><span style=\"color: #5cb874;\">Descendant</span> - A node reachable by repeated proceeding from parent to child.</li>
            <li><span style=\"color: #5cb874;\">Ancestor</span> - A node reachable by repeated proceeding from child to parent.</li>
            <li><span style=\"color: #5cb874;\">Leaf</span> - A node with no children.</li>
            <li><span style=\"color: #5cb874;\">Internal node</span> - A node with at least one child.</li>
            <li><span style=\"color: #5cb874;\">External node</span> - A node without children</li>
            <li><span style=\"color: #5cb874;\">Edge</span> - The connection between one node and another.</li>
            <li><span style=\"color: #5cb874;\">Degree</span> - The number of sub trees of a node.</li>
            <li><span style=\"color: #5cb874;\">Path</span> - A sequence of nodes and edges connecting a node with a descendant.</li>
            <li><span style=\"color: #5cb874;\">Level</span> - The level of a node is defined by 1 + (the number of connections between the node and the root).</li>
            <li><span style=\"color: #5cb874;\">Height of a node</span> - The height of a node is the number of edges on the longest path between that node and a leaf.</li>
            <li><span style=\"color: #5cb874;\">Height of a tree</span> - The height of a tree is the height of its root node.</li>
            <li><span style=\"color: #5cb874;\">Depth</span> - The depth of a node is the number of edges from the tree's root node to the node.</li>
            <li><span style=\"color: #5cb874;\">Forest</span> - A forest is a set of n ≥ 0 disjoint trees.</li>
          </ul>
        </p>
        ...
        <p>
          ...
          <div><img src=\"images/list_tree.png\" alt=\"\"></div>
          <li>Left Child-Right Sibling Representation</li>
         <div> <img src=\"images/left_right_tree.png\" alt=\"\"></div>
        </p>
        ...
        <span style=\"color: #5cb874;\"><h3 style=\"color: #5cb874;\"><i>Difference Between a Tree & a Binary Tree</i></h3></span>
        <ul>
        ...
        <div><img src=\"images/full-binary.jpg\" alt=\"full binary tree image\" ></div>
        ...
        <div><img src=\"images/strict-tree.png\" alt=\"\"></div>
        ...
        <div><img src=\"images/complete-binary.png\" alt=\"\"></div>
        <h2 style=\"color: #5cb874;\">Comparison</h2>
        <div ><img  src=\"images/binary-trees.png\" style=\"width: 100%; height: auto;\"></div>
        ...
        <ol>
          <li> <span style=\"color: #5cb874;\">Preorder Traversals</span>
            <div><img src=\"images/preorder_traversal.png\" alt=\"\"></div>
            <p>visit the root then traverse in preorder the children</p>
          </li>
          <li> <span style=\"color: #5cb874;\"> Postorder Traversals</span> <p>traverse in postorder the children then visit the root</p></li>
          <img src=\"images/post_order.png\" alt=\"\">
          <li style=\"color: #5cb874;\">Breadth-First Tree Traversal</li>
          ...
          <div><img src=\"images/bfs_traversal.png\" alt=\"\"></div>
          <p> The overall running time is O(n), due to the n calls to enqueue and n calls to dequeue.</p>
          <li style=\"color: #5cb874;\">Depth-first traversal</li>
        ...
        <div><img src=\"images/traversals.png\" alt=\"\"></div>
        ...
        <ul>
          <li style=\"color: #5cb874;\">Searching BST</li>
          ...
          <li style=\"color: #5cb874;\">Insert</li>
          ...
          <div><img src=\"images/insert_binary.png\" alt=\"\"></div>
          <li style=\"color: #5cb874;\">Delete</li>
        ...
        <div><img src=\"images/euler-tours.png\" alt=\"\"></div>
  ";

  $hashing_notes_display = "
        <h1 id=\"def_hash\" style=\"color: white;margin-bottom:10px;position:relative;top:10px;border-radius:15px; padding: 5px 20px; background-color: #5cb874;\">Hashing</h1>
        ...
        <div><img src=\"images/hash.png\" alt=\"\"></div>
        ...
        <ol>
          ...
          <li style=\"color: #5cb874;\">Folding Method</li>
          ...
          <li style=\"color: #5cb874;\">Modular Method</li>
        ...
        <p>There are several methods for dealing with collision:
          <ul>
            <li style=\"color: #5cb874;\">Separate chaining</li>
            <p>The idea is to keep a list of all elements that hash to the same value.</p>
            <li style=\"color: #5cb874;\">Open addressing</li>
          </ul>
        </p>
        <ul>
          <li><span style=\"color: #5cb874;\">Linear probing</span></li>
          ...
          <span style=\"color: #5cb874;\">When a collision occurs, look elsewhere in the table for an empty slot</span>
        </ul>
  ";

  $tower_of_hanoi_implementation = "
        <h1 id=\"def_tower_of_hanoi\" style=\"color: white;margin-bottom:10px;position:relative;top:10px;border-radius:15px; padding: 5px  20px; background-color: #5cb874;\">Tower Of Hanoi</h1>
  ...
  $fibonacci_implementation = "
        <h1 id=\"def_fibonacci\" style=\"color: white;position:relative;top:10px;border-radius:15px; padding: 5px  20px; background-color: #5cb874;\">Fibonacci Sequence</h1>
        <div style=\"width: 80%; margin: 0 auto;\">
  ...
  $factorial_implementation = "
        <h1 id=\"def_factorial\" style=\"color: white; position:relative;top:10px;border-radius:15px; padding: 5px  20px; background-color: #5cb874;\">Factorials</h1>
        <div style=\"width: 80%; margin: 0 auto;\">
  ...
  $hash_table_implementation = "
        <h1 id=\"def_hash_table\" style=\"color: white;position:relative;top:10px;border-radius:15px; padding: 5px  20px; background-color: #5cb874;\">Hash Table</h1>
  ...
  $list_implementation = "
        <h1 id=\"def_linked_list\" style=\"color: white;position:relative;top:10px;border-radius:15px; padding: 5px  20px; background-color: #5cb874;\">Linked List</h1>
        <div style=\"width: 80%; margin: 0 auto;\">
  ...
  ";
    ...
    $queue_implementation = "
        <h1 id=\"def_queue\" style=\"color: white;position:relative;top:10px;border-radius:15px; padding: 5px 20px; background-color: #5cb874;\">Queue</h1>
        <div style=\"width: 80%; margin: 0 auto;\">
    ...
    $circular_queue_implementation = "
        <h1 id=\"def_circular_queue\" style=\"color: white;position:relative;top:10px;border-radius:15px; padding: 5px  20px; background-color: #5cb874;\">Circular Queue</h1>
        <div style=\"width: 80%; margin: 0 auto;\">
  ...
  $stack_implementation = "
        <h1 id=\"def_stack\" style=\"color: white; position:relative;top:10px;border-radius:15px; padding: 5px  20px; background-color: #5cb874;\">Stack</h1>
        <div style=\"width: 80%; margin: 0 auto;\">
...
<body>
  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex align-items-center">
      <h1 class="logo me-auto"><a>DATA STRUCTURES AND ALGORITHMS</a></h1>
  ...
  <footer>
  <p style="bottom:0px;background-color: #6ec083;">Compiled by Group 10- <a href="maqamylee0@gmail.com"style="color:black;">Email us</a></p>
</footer>
